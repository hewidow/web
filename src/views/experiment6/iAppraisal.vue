<template>
  <v-container fluid>
    <v-row align="center" no-gutters>
      <v-col cols="2">
        <div class="font-weight-bold orange--text text-h5 text-center">4.9</div>
      </v-col>
      <v-col cols="4">
        <div>
          <div class="caption grey--text">高于88.4%的商家</div>
          <div>
            <v-rating
                :value="4.9"
      ...
      <v-col cols="2">
        <div class="grey--text caption">味道</div>
        <div class="font-weight-bold subtitle-1">4.9</div>
      </v-col>
      <v-col cols="2">
        <div class="grey--text caption">包装</div>
        <div class="font-weight-bold subtitle-1">4.9</div>
      </v-col>
      <v-col cols="2">
        <div class="grey--text caption">配送满意度</div>
        <div class="font-weight-bold subtitle-1">95%</div>
      </v-col>
    </v-row>
    <v-row>
      <v-col>
        <i-comment :comments="comments"></i-comment>
      </v-col>
    </v-row>
  </v-container>
</template>
...
<script>
import iComment from '../../components/experiment6/iComment'
export default {
  name: 'iAppraisal',
  components: {
    iComment
